...
// Source: Freenove official examples (github.com/Freenove)
// Key differences from AI-Thinker: PWDN=-1, XCLK=21, D3-D0 shifted
#define CAM_PIN_PWDN    -1   // not wired on Freenove board
#define CAM_PIN_RESET   -1
#define CAM_PIN_XCLK    21   // AI-Thinker=0
...
#define CAM_PIN_D3      19   // AI-Thinker=21
#define CAM_PIN_D2      18   // AI-Thinker=19
#define CAM_PIN_D1       5   // AI-Thinker=18
#define CAM_PIN_D0       4   // AI-Thinker=5
